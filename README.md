...
This is a project directory for our use case Zippy using Team Data Science Process developed by Microsoft. It also contains various documents that are recommended as part of executing a data science project when using TDSP. 
